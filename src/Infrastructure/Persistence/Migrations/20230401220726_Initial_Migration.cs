    ...
    public partial class Initial_Migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Category_To_Attribute", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Category_To_Attribute_Attribute_AttributeId",
                        column: x => x.AttributeId,
                        principalSchema: "Trendyol",
                        principalTable: "Attribute",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Category_To_Attribute_Category_CategoryId",
                        column: x => x.CategoryId,
                        principalSchema: "Trendyol",
                        principalTable: "Category",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AttributeValue_Category_To_Attribute_CategoryAttributeId",
                        column: x => x.CategoryAttributeId,
                        principalSchema: "Trendyol",
                        principalTable: "Category_To_Attribute",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeValue_CategoryAttributeId",
                schema: "Trendyol",
                table: "AttributeValue",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Category_To_Attribute_AttributeId",
                schema: "Trendyol",
                table: "Category_To_Attribute",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_Category_To_Attribute_CategoryId",
                schema: "Trendyol",
                table: "Category_To_Attribute",
                column: "CategoryId");
